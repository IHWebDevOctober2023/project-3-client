    ...
    return (
        <>
            <form className="form-createtask-container" onSubmit={handleSubmitTask}>
                ...
                <select className="input" id="timing-interval" name="timingInterval" onChange={handleTaskTime}>
                ...
                <select className="input" id="day-moment" name="dayMoment" onChange={handleTaskWeekDay}>
                ...
                <select className="input" name="personAssigned" onChange={handleTaskAssignedTo}>
